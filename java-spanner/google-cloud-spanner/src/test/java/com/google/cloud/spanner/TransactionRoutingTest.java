...
public class TransactionRoutingTest {
  ...
  public void setUp() {
    ...
    setClientDefaultOptions(IsolationLevel.ISOLATION_LEVEL_UNSPECIFIED, ReadLockMode.READ_LOCK_MODE_UNSPECIFIED);
  ...
  private void setClientDefaultOptions(IsolationLevel iso, ReadLockMode lock) {
    TransactionOptions defaultTxnOptions = TransactionOptions.newBuilder()
  ...
  public void testPrecedenceTier4SystemDefaults() {
    // Tier 4: Unspecified everywhere should fall back to SERIALIZABLE / PESSIMISTIC, routeToLeader=true.
  ...
  public void testPrecedenceTier3DatabaseDefaultsRepeatableReadUnspecifiedLock() {
    ...
    DatabaseMetadata dbMetadata = new DatabaseMetadata(
        Dialect.GOOGLE_STANDARD_SQL, IsolationLevel.REPEATABLE_READ, ReadLockMode.READ_LOCK_MODE_UNSPECIFIED);
    when(sessionReference.getDatabaseMetadata()).thenReturn(dbMetadata);
